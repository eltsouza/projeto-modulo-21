...
public class RelatorioService implements Serializable{
	...
	private static final String FOLDER_RELATORIOS = "/relatorios"; // pasta rais do relatório
	private static final String SUBREPORT_DIR = "SUBREPORT_DIR"; //sub relatorio é utilizando quando temos um registro de 1 para muitos
	private String SERATOR = File.separator; //  são as barras \ ou /
