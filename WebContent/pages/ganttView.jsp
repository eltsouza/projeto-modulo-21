...
<html>
	...
	<body>
		<h1>Gantt View é um plugin que é possivel encontrar no Github</h1>
				 ...
				 ganttData += "["; 
					...
					$.each(ganttDataResposta, function(index, projeto) {// for dos projetos
						...
						$.each(projeto.series, function(idx, serie) {// for das series
							...
							ganttData +="{ \"name\": \""+serie.nome+"\", \"start\":\""+ new Date(datainicial[0],datainicial[1]-1,datainicial[2])+"\", \"end\": \""+new Date(datafinal[0],datafinal[1]-1,datafinal[2])+"\" , \"color\": \""+cor+"\", \"projeto\": \""+serie.projeto+"\" , \"serie\": \""+serie.id+"\" }";
